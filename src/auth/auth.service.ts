...
export class AuthService implements OnModuleInit {
  ...
  private tokens = new Map<string, { email: string; userId: string; expiresAt: number }>();
  ...
  async sendOtpEmail(toEmail: string, code: string): Promise<void> {
    ...
    const senderEmail = this.configService.get<string>('SENDER_EMAIL') || 'onboarding@resend.dev';
    ...
    await axios.post(
      ...
      { from: senderEmail, to: [toEmail], subject: `${code} is your LeadSphere AI verification code`, html },
